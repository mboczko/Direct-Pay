$(function(){
    ...
    var data_variable = Handlebars.compile($("#contract-body-script-template").html());
    function showContractBody(){
        var data_input = [
        ...
        for (var i = 0; i < data_input.length; i++) {
            ...
            data.push({
                p_number: p_number,
                p_text: Messages("directpay.contract." + data_input[i].key),
                p_class: p_class,
                p_level1: level[1],
                p_level: p_level
            });
        }
        $('#contract-body-script-position').html(data_variable(data));
    }
    showContractBody();
